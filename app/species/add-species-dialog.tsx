...
// setting up the form for the Wikipedia Search
...
export default function AddSpeciesDialog({ userId }: { userId: string }) {
  ...
  //the form for the Wikipedia input
  const form2 = useForm<z.infer<typeof inputSchema>>({
